...
protected:
	// Virtual function override for viewport generation (DOES NOT USE MESSAGE MAPS)
...
private:
	...
	CSplitterWnd m_wndSplitter; // The physical 3D split view controller container
