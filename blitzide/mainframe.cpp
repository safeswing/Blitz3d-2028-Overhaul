...
int MainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct) {
	...
	statusBar.ModifyStyleEx(WS_EX_CLIENTEDGE, 0, SWP_FRAMECHANGED); // Strips white horizontal lip
...
void MainFrame::cursorMoved(Editor* editor) {
	...
	// Set the status bar text background transparent and paint fonts in bright white
	statusBar.GetStatusBarCtrl().SetBkColor(RGB(30, 30, 30));
